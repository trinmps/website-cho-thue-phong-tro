			...
			<div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
			  <div class="card border-2 shadow rounded-3 my-5">
				<div class="card-body p-4 p-sm-5">
				  <h5 class="card-title text-center mb-5 fw-info  fs-5">Đăng ký tài khoản</h5>
				  <form:form action="/user/register" method="post" modelAttribute="item">
					...
					<hr class="my-4">
					<div class="d-grid">
					  <form:button formaction="/user/create" class="btn btn-primary btn-login text-uppercase fw-bold" type="submit"  data-bs-toggle="modal" data-bs-target="#exampleModal">Đăng ký</form:button>
					</div>	
					<h5 class="text-center mt-3" style="color: red;" >${message}</h5>	
					<div class="text-center " ><a class="" href="/user/login" style="font-size: 15px;"> Quay lại đăng nhập</a></div>
            </form:form>
          </div>
        </div>
      </div>
