          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
              <ul class="navbar-nav">
                ...
                <li class="nav-item mx-2 m-auto">
                  <a href="/user/thuephong" style="text-decoration: none;">
                    <i class="bi bi-houses"></i> Thuê phòng
                  </a>
                </li>
                <li class="nav-item mx-2 m-auto">
                  <a href="/user/tintuc" style="text-decoration: none;">
                    <i class="bi bi-tablet-landscape"></i> Tin tức
                  </a>
                </li>
                <li class="nav-item mx-2 m-auto">
                  <a href="/user/lienhe" style="text-decoration: none;">
                    <i class="bi bi-headphones"></i> Liên hệ
                  </a>
                </li>

                <li class="nav-item mx-3 m-auto">
                  <form action="/admin/editsanpham"><button class="btn btn-outline-success" type="submit"><i
                        class="bi bi-file-earmark-plus-fill"></i> Đăng tin</i></button></form>
                </li>
                <li class="nav-item mx-2 m-auto">
                  <c:choose>
                    <c:when test="${user.vaitro==true}">
                      <a href="/admin/sanpham" class="btn btn-outline-success" type="submit"><i class="bi bi-table"></i>
                        Quản lý</i></a>
                    </c:when>
